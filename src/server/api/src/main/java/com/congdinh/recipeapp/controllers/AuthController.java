...
import com.congdinh.recipeapp.dtos.auth.LoginDTO;
import com.congdinh.recipeapp.dtos.auth.LoginResponseDTO;
import com.congdinh.recipeapp.dtos.auth.RegisterDTO;
import com.congdinh.recipeapp.sevices.AuthService;
import com.congdinh.recipeapp.sevices.TokenService;
...
public class AuthController {
    ...
    public ResponseEntity<Boolean> register(@Valid @RequestBody RegisterDTO registerDTO) {
        ...
        var result = authService.save(registerDTO);
